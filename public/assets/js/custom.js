...
// Loading
// Tunggu sampai seluruh halaman (termasuk gambar, script, dll) selesai dimuat
// $(window).on('load', function () {
//   $("#loading-wrapper").fadeOut('very fast'); // hilangkan loading setelah halaman siap
// });

// Event untuk tombol sorting hari
$(function () {
